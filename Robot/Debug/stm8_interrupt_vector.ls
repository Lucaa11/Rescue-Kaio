  ...
  43                     ; 11 @far @interrupt void NonHandledInterrupt (void)
  43                     ; 12 {
  44                     	switch	.text
  ...
  76  0014 82            	dc.b	130
  78  0015 00            	dc.b	page(f_ISR_MOT3)
  79  0016 0000          	dc.w	f_ISR_MOT3
  80  0018 82            	dc.b	130
  82  0019 00            	dc.b	page(f_NonHandledInterrupt)
  83  001a 0000          	dc.w	f_NonHandledInterrupt
  84  001c 82            	dc.b	130
  86  001d 00            	dc.b	page(f_ISR_MOT2)
  87  001e 0000          	dc.w	f_ISR_MOT2
  88  0020 82            	dc.b	130
  90  0021 00            	dc.b	page(f_ISR_MOT1)
  91  0022 0000          	dc.w	f_ISR_MOT1
  92  0024 82            	dc.b	130
  94  0025 00            	dc.b	page(f_ISR_MOT0)
  95  0026 0000          	dc.w	f_ISR_MOT0
  96  0028 82            	dc.b	130
 ...
 118  003d 00            	dc.b	page(f_ISR_TIM2)
 119  003e 0000          	dc.w	f_ISR_TIM2
 120  0040 82            	dc.b	130
 122  0041 00            	dc.b	page(f_ISR_TIM2_CC)
 123  0042 0000          	dc.w	f_ISR_TIM2_CC
 ...
 138  0051 00            	dc.b	page(f_ISR_Ser1)
 139  0052 0000          	dc.w	f_ISR_Ser1
 ...
 150  005d 00            	dc.b	page(f_ISR_Ser)
 151  005e 0000          	dc.w	f_ISR_Ser
